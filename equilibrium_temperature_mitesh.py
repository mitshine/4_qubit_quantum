...
print("Percentage of Stablity (Stability Ratio): ", round((x*100)/y, 3), "%")
print("\n")
...
print("Percentage of Stablity without probabislitic r-value (Stability Ratio): ", round((finite_x*100)/y, 3), "%")
print("\n")

print("Percentage of finite_x vs. r-stable states (Difference of probabilistic stable states and finite stable states without probabilistic r-value): ", round(((x - finite_x)*100)/y, 3), "%")
print("\n")

print("Simulation Completed !")
# print("Simulation time: ", (end - start)*1000, " milliseconds")
print("Elapsed Simulation Time: ", round(end - start, 3), " seconds")
